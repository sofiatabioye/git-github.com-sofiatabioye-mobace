...
interface ConfirmRemovalModalProps {
  isOpen: boolean;
  onClose: () => void;    // If user cancels
  onConfirm: () => void; // If user confirms
}
          ...
          >
            <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-center align-middle transition-all transform bg-[#222] rounded-lg shadow-xl">
              ...
              <div className="flex flex-col items-center">
                ...
                <h2 className="text-2xl font-bold text-white mt-4">Remove Device?</h2>
                <p className="text-gray-400 mt-2">
                  Removing this device would require registering the device again.
                  <br />
